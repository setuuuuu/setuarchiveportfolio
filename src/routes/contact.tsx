    ...
    <div>
      <section className="border-b border-ink/90">
        <div className="mx-auto max-w-[1600px] px-6 pb-16 pt-16 md:px-12 md:pb-24 md:pt-24">
          <p className="text-xs uppercase tracking-widest text-ink-soft">{contact.heading}</p>
      ...
      <section className="mx-auto max-w-[1600px] px-6 py-16 md:px-12 md:py-24">
        <div className="grid grid-cols-12 gap-12">
          <div className="col-span-12 md:col-span-5">
            ...
            <a href={`mailto:${contact.email}`} className="link-underline mt-3 block font-display text-3xl uppercase md:text-4xl break-all">
              {contact.email}
            </a>

            <div className="mt-12 space-y-6 text-sm">
              <div>
                <p className="text-xs uppercase tracking-widest text-ink-soft">Location</p>
                <p className="mt-2 whitespace-pre-line">{contact.location}</p>
              </div>
              <div>
                <p className="text-xs uppercase tracking-widest text-ink-soft">Intro</p>
                <p className="mt-2">{contact.intro}</p>
              </div>
            </div>
          </div>
